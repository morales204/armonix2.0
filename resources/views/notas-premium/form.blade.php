<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            <label for="id_nota_p" class="form-label">{{ __('Id Nota') }}</label>
        ...
        <div class="form-group mb-2 mb20">
            <label for="nombre_nota_p" class="form-label">{{ __('Nombre de la Nota') }}</label>
        ...
        <div class="form-group mb-2 mb20">
            <label for="contenido_nota_p" class="form-label">{{ __('Contenido') }}</label>
