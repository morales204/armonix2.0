...
@section('content')
    <div class="card card-primary mt-4">
        ...
        <!-- /.card-header -->
        <!-- form start -->
        <form action=" {{ route('usuario.update',$usuario->id_usuario) }}" method="POST" class="form">
            @csrf
            @method('PUT')
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('nombre_completo') is-invalid @enderror"
                        id="nombre_completo" name="nombre_completo" value="{{  old('username', $usuario->nombre_completo) }}"
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control @error('telefono') is-invalid @enderror" id="telefono"
                        name="telefono" value="{{  old('username', $usuario->telefono) }}"
                ...
                <div class="form-group">
                    ...
                    <input type="email" class="form-control  @error('correo') is-invalid @enderror" id="correo"
                        name="correo" placeholder="Ingrese un correo electronico" value="{{  old('username', $usuario->correo) }}">
                    @error('correo')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('username') is-invalid @enderror" id="username"
                        name="username" placeholder="Ingrese el nombre de usuario" value="{{  old('username', $usuario->username) }} ">
                    @error('username')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
