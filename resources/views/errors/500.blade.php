    ...
    <div id="notfound">
        <div class="notfound">
            <div class="notfound-404">
                <h1>5<span>0</span>0</h1> <!-- Cambio de 404 a 500 -->
            </div>
            <br>
            <p>Lo sentimos, pero parece que hubo un error interno en el servidor. Intenta de nuevo más tarde.</p> <!-- Mensaje de error 500 -->
            <!--  <a href="#">home page</a> -->
            <img src="{{ asset('osin.webp')}}" alt="Error 500"> <!-- Imagen asociada -->
        </div>
    </div>
</body>
