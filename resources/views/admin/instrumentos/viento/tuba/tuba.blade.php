                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                            <div class="card">
                                <img src="{{ asset('img/curso1_tuba.png') }}" class="card-img-top" alt="...">
                                <div class="card-body">
                        ...
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                            <div class="card">
                                <img src="{{ asset('img/curso2_tuba.png') }}" class="card-img-top" alt="...">
                                <div class="card-body">
                        ...
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                            <div class="card">
                                <img src="{{ asset('img/curso3_tuba.png') }}" class="card-img-top" alt="...">
                                <div class="card-body">
